...
function readInheritableStaticObjectPairs(constructor, propertyName) {
	return getAncestorsForConstructor(constructor).reduce((pairs, constructor) => {
...
var OutletObserver = class {
	...
	get outletDependencies() {
		...
		this.router.modules.forEach((module) => {
			...
			readInheritableStaticArrayValues(constructor, "outlets").forEach((outlet) => dependencies.add(outlet, module.identifier));
		});
		return dependencies;
	}
...
function getShadowProperties(prototype, properties) {
	return getOwnKeys(properties).reduce((shadowProperties, key) => {
		...
		if (descriptor) Object.assign(shadowProperties, { [key]: descriptor });
...
var Router = class {
	...
	connectModule(module) {
		...
		this.scopesByIdentifier.getValuesForKey(module.identifier).forEach((scope) => module.connectContextForScope(scope));
	}
	disconnectModule(module) {
		this.modulesByIdentifier.delete(module.identifier);
		this.scopesByIdentifier.getValuesForKey(module.identifier).forEach((scope) => module.disconnectContextForScope(scope));
	}
};
var defaultSchema = {
